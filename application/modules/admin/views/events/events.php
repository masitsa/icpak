...
<div class="container-fluid">
    <div class="panel panel-default">
        <div class="panel-heading panel-heading-gray">
            <i class="fa fa-bookmark"></i> All events
            <div class="pull-right">
            	<!-- <a href="<?php echo base_url();?>calender"  class="btn btn-info btn-sm " style="margin-right:5px;" ><i class="fa fa-fw fa-mail-reply"></i>  Back Events Calender</a> -->
		 		<button type="button" class="btn btn-primary btn-sm  " data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-fw fa-plus-square"></i> Add a new meeting</button>
		 	...
		 	<div class="col-md-12 col-lg-12">
			 	<div class="panel panel-default">
			        ...
			        <div class="table-responsive">
			        	 <table data-toggle="data-table" class="table col-md-11 col-lg-12" cellspacing="0">
	                    <thead>
	                        <tr>
	                             <th >#</th>
		                        <th>Subject</th>
									...
									foreach ($query->result() as $row)
									{
					                	...
					                	?>
						                    <tr>
						                        ...
						                        <td><a class="btn btn-default btn-xs"><?php echo $meeting_date;?> - <?php echo $end_date;?></a>
						                        </td>
						                        ...
						                        <td><?php echo $department_name?></td>
						                     	<td><?php echo $button;?></td>
						                       	<td>
						                       		<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target=".bs-edit-event-modal-lg<?php echo $meeting_id;?>"><i class="fa fa-pencil"></i> Edit </button>
						                       		 <div class="modal fade bs-edit-event-modal-lg<?php echo $meeting_id;?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
														  <div class="modal-dialog modal-lg">
														    <div class="modal-content">
