        ...
        <?php
           ...
           $agenda = $this->site_model->get_meeting_agenda($meeting_id);
            ...
            if($agenda->num_rows() > 0)
            {
                ...
                ?>
                <textarea id="editor2" name="editor2" rows="" cols="100" style="100%" class="form-control col-md-6" ><?php echo $meeting_agenda;?></textarea>
                <?php
            }
            else
            {
                ?>
                <textarea id="editor2" name="editor2" rows="" cols="100" style="100%" class="form-control col-md-6" ></textarea>
                <?php
            }
        ?>
    </div>
